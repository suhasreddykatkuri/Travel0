...
const { v4: uuid } = require('uuid'); // Import uuid for generating IDs

// Define your hotels data
const hotels = {
    "data": [
        {
            id: uuid(),
...
async function uploadHotels() {
    const uri = 'mongodb+srv://suchirreddy5:I8r7oBvg3S3Diq1u@cluster0.sabwmds.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
    ...
    try {
        ...
        const collection = database.collection('hotels'); // Replace with your collection name

        // Insert many documents
        const result = await collection.insertMany(hotels.data);
        console.log(`${result.insertedCount} hotels inserted.`);
    } finally {
        await client.close();
    }
}

uploadHotels().catch(console.error);
